  ...
  public: {
    Tables: {
      ...
      duplicates: {
        ...
        Relationships: [
          {
            foreignKeyName: "duplicates_duplicate_document_id_fkey"
          ...
          {
            foreignKeyName: "duplicates_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "duplicates_source_document_id_fkey"
    ...
    Enums: {
      ...
      duplicate_status: "exact" | "similar" | "reviewed" | "dismissed"
